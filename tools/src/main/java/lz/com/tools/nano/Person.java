...
public final class Person extends
  ...
  public static final class PhoneNumber extends
    ...
    public PhoneNumber clear() {
      type = lz.com.tools.nano.Person.PhoneType.MOBILE;
      cachedSize = -1;
      return this;
    }
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.type != lz.com.tools.nano.Person.PhoneType.MOBILE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 16: {
            ...
            switch (value) {
              case lz.com.tools.nano.Person.PhoneType.MOBILE:
              case lz.com.tools.nano.Person.PhoneType.HOME:
              case lz.com.tools.nano.Person.PhoneType.WORK:
                this.type = value;
                break;
            }
            break;
  ...
  public lz.com.tools.nano.Person.PhoneNumber[] phone;
  ...
  public Person clear() {
    ...
    id = 0;
    email = "";
    phone = lz.com.tools.nano.Person.PhoneNumber.emptyArray();
    cachedSize = -1;
    return this;
  }
  ...
  public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
    ...
    if (this.phone != null && this.phone.length > 0) {
      for (int i = 0; i < this.phone.length; i++) {
        lz.com.tools.nano.Person.PhoneNumber element = this.phone[i];
        if (element != null) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        case 34: {
          ...
          lz.com.tools.nano.Person.PhoneNumber[] newArray =
              new lz.com.tools.nano.Person.PhoneNumber[i + arrayLength];
          if (i != 0) {
            java.lang.System.arraycopy(this.phone, 0, newArray, 0, i);
          }
          for (; i < newArray.length - 1; i++) {
            newArray[i] = new lz.com.tools.nano.Person.PhoneNumber();
