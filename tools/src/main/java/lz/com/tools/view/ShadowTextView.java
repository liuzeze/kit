...
public class ShadowTextView extends AppCompatTextView {
    ...
    public void setPading() {
        ...
        setPadding(leftPading + getPaddingLeft(), topPading + getPaddingTop(), rightPading + getPaddingRight(), bottomPading + getPaddingBottom());
    }
   ...
   /* @Override
    ...
    public ShadowTextView setOffsetX(float offsetX) {
    ...
    public ShadowTextView setOffsetY(float offsetY) {
    ...
    public ShadowTextView setShadowBlur(float shadowBlur) {
        mShadowBlur = shadowBlur;

        return this;
    }

    public ShadowTextView setUnBackGroundColor(int unBackGroundColor) {
        mUnBackGroundColor = unBackGroundColor;
        return this;
    }

    public ShadowTextView setUnShadowColor(int unShadowColor) {
        mUnShadowColor = unShadowColor;
        return this;
    }

    public ShadowTextView setStrokeColor(int strokeColor) {
        mStrokeColor = strokeColor;
        return this;
    }

    public ShadowTextView setUnStrokeColor(int unStrokeColor) {
        mUnStrokeColor = unStrokeColor;

        return this;
    }

    public ShadowTextView setBackGroundColor(int backGroundColor) {
