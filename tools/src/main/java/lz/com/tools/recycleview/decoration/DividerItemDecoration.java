...
public abstract class DividerItemDecoration extends RecyclerView.ItemDecoration {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (divider != null) {
                ...
                if (divider.getLeftSideLine().isHave()) {
                    int lineWidthPx = LzDp2Px.dp2px(context, divider.getLeftSideLine().getWidthDp());
                    int startPaddingPx = LzDp2Px.dp2px(context, divider.getLeftSideLine().getStartPaddingDp());
                    int endPaddingPx = LzDp2Px.dp2px(context, divider.getLeftSideLine().getEndPaddingDp());
                ...
                if (divider.getTopSideLine().isHave()) {
                    int lineWidthPx = LzDp2Px.dp2px(context, divider.getTopSideLine().getWidthDp());
                    int startPaddingPx = LzDp2Px.dp2px(context, divider.getTopSideLine().getStartPaddingDp());
                    int endPaddingPx = LzDp2Px.dp2px(context, divider.getTopSideLine().getEndPaddingDp());
                ...
                if (divider.getRightSideLine().isHave()) {
                    int lineWidthPx = LzDp2Px.dp2px(context, divider.getRightSideLine().getWidthDp());
                    int startPaddingPx = LzDp2Px.dp2px(context, divider.getRightSideLine().getStartPaddingDp());
                    int endPaddingPx = LzDp2Px.dp2px(context, divider.getRightSideLine().getEndPaddingDp());
                ...
                if (divider.getBottomSideLine().isHave()) {
                    int lineWidthPx = LzDp2Px.dp2px(context, divider.getBottomSideLine().getWidthDp());
                    int startPaddingPx = LzDp2Px.dp2px(context, divider.getBottomSideLine().getStartPaddingDp());
                    int endPaddingPx = LzDp2Px.dp2px(context, divider.getBottomSideLine().getEndPaddingDp());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        int left = divider.getLeftSideLine().isHave() ? LzDp2Px.dp2px(context, divider.getLeftSideLine().getWidthDp()) : 0;
        int top = divider.getTopSideLine().isHave() ? LzDp2Px.dp2px(context, divider.getTopSideLine().getWidthDp()) : 0;
        int right = divider.getRightSideLine().isHave() ? LzDp2Px.dp2px(context, divider.getRightSideLine().getWidthDp()) : 0;
        int bottom = divider.getBottomSideLine().isHave() ? LzDp2Px.dp2px(context, divider.getBottomSideLine().getWidthDp()) : 0;
    ...
    Divider getDivider(RecyclerView parent, int itemPosition);
