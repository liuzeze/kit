...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setAdapter(@IdRes int viewId, BaseRecycleAdapter adapter) {
    ...
    @SuppressWarnings("unchecked")
    public BaseViewHolder setLayoutManager(@IdRes int viewId, RecyclerView.LayoutManager layoutManager) {
        RecyclerView view = getView(viewId);
        view.setLayoutManager(layoutManager);
        return this;
    }

    public BaseViewHolder setSelected(@IdRes int viewId, boolean isSelected) {
        View view = getView(viewId);
        view.setSelected(isSelected);
        return this;
    }

    protected BaseViewHolder setAdapter(BaseRecycleAdapter adapter) {
