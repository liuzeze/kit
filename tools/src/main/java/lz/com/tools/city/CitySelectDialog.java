...
public class CitySelectDialog extends DialogFragment {
    ...
    public static CitySelectDialog newInstance(int[] position, ArrayList<CityPickerInfo> areaItem) {
        return newInstance(position, areaItem, null);
    }

    public static CitySelectDialog newInstance(int[] position, ArrayList<CityPickerInfo> areaItem, String leftTitleStr) {
        CitySelectDialog fragment = new CitySelectDialog();
        Bundle args = new Bundle();
        args.putSerializable(ARG_PARAM1, areaItem);
        args.putIntArray(ARG_PARAM_SELECT_POSITION, position);
        args.putString(ARG_PARAM_TITLE, leftTitleStr);
    ...
    public void onResume() {
        super.onResume();
        getDialog().getWindow().setLayout(getResources().getDisplayMetrics().widthPixels, getResources().getDisplayMetrics().heightPixels * 2 / 5);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mTitleStr = getArguments().getString(ARG_PARAM_TITLE);
            int[] position = getArguments().getIntArray(ARG_PARAM_SELECT_POSITION);
            if (serializable != null && serializable instanceof ArrayList) {
                mAreaItem = (List<CityPickerInfo>) serializable;
            }
            if (position != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        params.windowAnimations = R.style.dialog_animations;
    ...
    public void initView(Context base) {
        mMAreaFilter = View.inflate(base, R.layout.layout_city_select, null);
